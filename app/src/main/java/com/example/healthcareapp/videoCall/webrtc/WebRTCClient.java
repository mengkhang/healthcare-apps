package com.example.healthcareapp.videoCall.webrtc;
...
public class WebRTCClient {
    ...
    public WebRTCClient(Context context, PeerConnection.Observer observer, String useruid, String username) {
        ...
        rtcAudioManager = RTCAudioManager.create(this.context);
        rtcAudioManager.setDefaultAudioDevice(RTCAudioManager.AudioDevice.SPEAKER_PHONE);  //this code set audio to speaker phone.
    }
                        ...
                        public void onSetSuccess() {
                            ...
                            if (listener!=null){
                                listener.onTransferDataToOtherPeer(new DataModel(
                                        target,useruid, username, sessionDescription.description, DataModelType.Offer
                                ));
                            }
                        }
                    },sessionDescription);
                ...
                public void onCreateSuccess(SessionDescription sessionDescription) {
                    ...
                    peerConnection.setLocalDescription(new MySdpObserver(){
                        ...
                        public void onSetSuccess() {
                            ...
                            if (listener!=null){
                                listener.onTransferDataToOtherPeer(new DataModel(
                                        target,useruid,username, sessionDescription.description, DataModelType.Answer
                                ));
                            }
                        }
                    },sessionDescription);
    ...
    public void sendIceCandidate(IceCandidate iceCandidate, String target){
        ...
        if (listener!=null){
            listener.onTransferDataToOtherPeer(new DataModel(
                    target,useruid,username, gson.toJson(iceCandidate),DataModelType.IceCandidate
            ));
        }
    }
...
//        RTCAudioManager.AudioDevice type = mapToDevice(Type);
//        if (type != null) {
//            rtcAudioManager.setDefaultAudioDevice(type);
//            rtcAudioManager.selectAudioDevice(type);
//            Log.d(TAG, "handleToggleAudioDevice: " + type);
//        }
//    }
//
//    RTCAudioManager.AudioDevice mapToDevice(String type) {
//        if (RTCAudioManager.AudioDevice.EARPIECE.name().equals(type)) {
//            return RTCAudioManager.AudioDevice.EARPIECE;
//        } else if (RTCAudioManager.AudioDevice.SPEAKER_PHONE.name().equals(type)) {
//            return RTCAudioManager.AudioDevice.SPEAKER_PHONE;
//        }
